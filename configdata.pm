...
our %config = (
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "C:\\cpython-3.11\\externals\\openssl-1.1.1m\\Configurations\\00-base-templates.conf", "C:\\cpython-3.11\\externals\\openssl-1.1.1m\\Configurations\\10-main.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
...
our %target = (
  ...
  MT => "mt",
  MTFLAGS => "-nologo",
  RANLIB => "CODE(0x664a68)",
  RC => "rc",
  _conf_fname_int => [ "C:\\cpython-3.11\\externals\\openssl-1.1.1m\\Configurations\\00-base-templates.conf", "C:\\cpython-3.11\\externals\\openssl-1.1.1m\\Configurations\\00-base-templates.conf", "C:\\cpython-3.11\\externals\\openssl-1.1.1m\\Configurations\\10-main.conf", "C:\\cpython-3.11\\externals\\openssl-1.1.1m\\Configurations\\10-main.conf", "C:\\cpython-3.11\\externals\\openssl-1.1.1m\\Configurations\\00-base-templates.conf", "C:\\cpython-3.11\\externals\\openssl-1.1.1m\\Configurations\\10-main.conf", "C:\\cpython-3.11\\externals\\openssl-1.1.1m\\Configurations\\shared-info.pl" ],
